...
from bokeh.models import BoxSelectTool, LassoSelectTool, ColumnDataSource, Circle, Slider, HoverTool
...
def make_box_plots(aoi_name, file_path, output_filename):
    ...
    TOOLS_NEW = "pan,wheel_zoom,box_select,lasso_select,reset"
    ...
    p00 = figure(tools=TOOLS_NEW, x_axis_label='Building density', y_axis_label='Complexity', plot_width=FIG_W, plot_height=FIG_H, title="{}\nbldg_density".format(title))
    p00.add_tools(my_hover)
